...
public class Fecha implements Comparable<Fecha> {
	...
	public int diasDeDiferencia(Fecha f2) {
		// Creo los LocalDate
		LocalDate inicio = LocalDate.of(this.anio(), this.mes(), this.dia());
		LocalDate fin = LocalDate.of(f2.anio(), f2.mes(), f2.dia());
		return (int) DAYS.between(inicio, fin);
	}
	...
	public String toString() {
		...
		Integer m = mes();
		Integer a = anio();
		return "fecha: " + d.toString() + "/" + m.toString() + "/" + a.toString();
	}
